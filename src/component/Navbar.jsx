              ...
              <>
                <div className="max-w-7xl px-2 sm:px-6 lg:px-8">
                  <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-stretch justify-center sm:items-stretch sm:justify-start">
                      <div className="flex flex-shrink-0 items-center">
                        <img
                          className="h-11 w-auto rounded-full border-2 border-white "
                          src="src/assets/db_logo.webp"
                          alt="Your Company"
                        />
                      </div>
